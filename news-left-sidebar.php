         ...
         <!--Recent post end -->
          ...
          <div class="widget">
            ...
            <ul class="arrow nav nav-tabs">
              <li><a href="news-left-sidebar.php">Microwave</a></li>
                            <li><a href="news-single.php">chimney</a></li>
                            <li><a href="team.php">oven</a></li>
                            <li><a href="team.php">Gyser</a></li>
                            <li><a href="team.php">HOb</a></li>
                            <li><a href="team.php">Cooktop</a></li>
            </ul>
          </div><!-- Categories end -->
          ...
          <div class="post-body">
            <div class="entry-header">
              ...
              <h2 class="entry-title">
                <a href="news-single.php">We Just Completes $17.6 million Medical Clinic in Mid-Missouri</a>
              </h2>
            </div><!-- header end -->
